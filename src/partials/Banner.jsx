    ...
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
        <div className="bg-gray-800 border border-transparent dark:border-gray-700/60 text-gray-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          <div className='text-gray-500 inline-flex'><a className="font-medium hover:underline text-gray-50" href={'https://www.github.com/Hzkun001'} target="_blank" rel="noreferrer">Check<span className="hidden sm:inline"> my GitHub</span></a></div>
